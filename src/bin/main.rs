...
#[get("/productcategory")]
fn get_all_product_categories(db_conn: DbConn) -> Json<Vec<ProductCategory>> {
    use warehouse_rs::schema::product_category::dsl::*;
...
fn main() {
    rocket::ignite()
        ...
        .mount("/", routes![create_product_category, get_all_product_categories, get_product_category])
        .launch();
}
...
mod tests {
    ...
    use testcontainers::{images, Docker, Container};
    ...
    fn start_database<'a>(docker: &'a Cli) -> DatabaseMetadata<'a> {
